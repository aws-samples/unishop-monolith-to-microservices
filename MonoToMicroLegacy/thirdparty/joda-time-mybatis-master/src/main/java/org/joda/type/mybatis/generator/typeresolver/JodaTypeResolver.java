...
package org.joda.type.mybatis.generator.typeresolver;
...
// Once bug http://code.google.com/p/mybatis/issues/detail?id=359 is fixed, the class can be simplified to:
//public class JodaTypeResolver extends JavaTypeResolverDefaultImpl
//{
...
public class JodaTypeResolver implements JavaTypeResolver
{
